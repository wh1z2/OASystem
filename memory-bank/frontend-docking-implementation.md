...
| 验证项 | 操作步骤 | 预期结果 | 实际结果 |
|--------|----------|----------|----------|
| 登录流程 | 1. 输入账号密码<br>2. 点击登录 | 登录成功，跳转到首页 | |
| 审批列表 | 1. 打开审批管理页面 | 显示后端真实数据 | |
| 审批筛选 | 1. 选择筛选条件<br>2. 点击搜索 | 筛选结果正确 | |
| 创建审批 | 1. 填写表单<br>2. 提交 | 创建成功，跳转到详情 | |
| 审批通过 | 1. 打开审批详情<br>2. 点击通过 | 状态变为已通过 | |
| 审批拒绝 | 1. 打开审批详情<br>2. 点击拒绝 | 状态变为已打回 | |
| 待办列表 | 1. 打开待办页面 | 显示当前用户待办 | |
| 已办列表 | 1. 打开已办页面 | 显示已处理工单 | |
| 更新资料 | 1. 修改个人信息<br>2. 保存 | 更新成功 | |
| 修改密码 | 1. 输入原密码和新密码<br>2. 提交 | 密码修改成功 | |
